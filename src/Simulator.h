...
class AVO_EXPORT Simulator {
 public:
   ...
   * @param[in] agentNo The number of the agent whose acceleration interval is
   *                    to be retrieved.
   ...
   * @param[in] agentNo The number of the agent whose maximum acceleration is to
   *                    be retrieved.
  ...
  void setAgentDefaults(float neighborDist = 10.0f,
                        std::size_t maxNeighbors = 10,
                        float timeHorizon = 10.0f,
                        float radius = 0.25f,
                        float maxSpeed = 2.0f,
                        float maxAccel = .0f,
                        float accelInterval = 0.1f);
   ...
   * @details   The preferred velocity of an agent is the velocity it would
   *            choose to take if it were not influenced by other agents.
   * @param[in] agentNo      The number of the agent whose preferred velocity is
   *                         to be modified.
